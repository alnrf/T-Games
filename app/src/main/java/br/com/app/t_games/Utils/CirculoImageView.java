package br.com.app.t_games.Utils;
...
/**
 * Created by Fabiano on 28/03/2017.
 */

public class CirculoImageView extends android.support.v7.widget.AppCompatImageView {

    public CirculoImageView(Context context) {
        super(context);
    }

    public CirculoImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CirculoImageView(Context context, AttributeSet attrs, int defStyle) {
